...
$string['awardaxpwhen'] = '<strong>{$a->points}</strong> points with <strong>{$a->reputationpath}</strong> reputation are earned when:';
...
$string['setreputationpath'] = 'Set reputation path';
